...
public final class ModTreeGrowers {
    ...
    private static final ResourceKey<ConfiguredFeature<?, ?>> MEGA_CURSED_FROST_TREE_FEATURE = ResourceKey.create(
            Registries.CONFIGURED_FEATURE, TheAurorian2.id("mega_cursed_frost_tree"));
    ...
    public static final TreeGrower CURSED_FROST_TREE = new TreeGrower(
            "theaurorian2:cursed_frost_tree", Optional.of(MEGA_CURSED_FROST_TREE_FEATURE),
            Optional.of(CURSED_FROST_TREE_FEATURE), Optional.empty());
