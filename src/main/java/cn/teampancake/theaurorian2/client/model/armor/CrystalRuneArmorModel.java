...
public final class CrystalRuneArmorModel {
    private CrystalRuneArmorModel() {
    }
    ...
    public static LayerDefinition createBodyLayer(ArmorType type) {
        ...
        PartDefinition body = partDefinition.addOrReplaceChild("body", LegacyArmorParts.body(type, CubeListBuilder.create()
