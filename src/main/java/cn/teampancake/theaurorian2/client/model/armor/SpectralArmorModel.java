...
public final class SpectralArmorModel {
    private SpectralArmorModel() {
    }
    ...
    public static LayerDefinition createBodyLayer(ArmorType type) {
        ...
        partDefinition.addOrReplaceChild("right_leg", LegacyArmorParts.leg(type, CubeListBuilder.create()
                ...
                .texOffs(21, 52).addBox(-2.5F, 3.25F, -2.5F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.2F)), 0, 1, 3), PartPose.offset(-1.9F, 12.0F, 0.0F));
        partDefinition.addOrReplaceChild("left_leg", LegacyArmorParts.leg(type, CubeListBuilder.create()
                ...
                .texOffs(0, 16).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.29F)).mirror(false), 0, 2, 3), PartPose.offset(1.9F, 12.0F, 0.0F));
