...
for key,name in NAMES.items():
 ...
 for y in range(64):
  for x in range(64):
   ...
   else:rgb=ramp((lum-45)/210,[(48,45,79),(114,132,153),(180,207,211)])
...
d.text((60,32),'极光工具 · 原模型改色预览',font=font(44),fill='#ecf4ff')
d.text((62,102),'直接使用 Adventurer Tools 模型 · 保留造型和 UV · 蓝灰木色与蓝色装饰 · 未接入游戏',font=font(22),fill='#9fb6c9')
